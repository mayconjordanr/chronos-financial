...
exports.CATEGORY_ROUTES_CONFIG = void 0;
...
async function categoryRoutes(fastify, options) {
    const categoryService = new categories_service_1.CategoryService(options.prisma);
    const categoryController = new categories_controller_1.CategoryController(categoryService);
...
exports.CATEGORY_ROUTES_CONFIG = {
    prefix: '/api/v1',
    tags: ['Categories'],
